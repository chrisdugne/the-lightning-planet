...
function scene:displayContent()
	...
	local title = display.newText( newRecordMenu, "New Record !", 0, 0, FONT, 25 )
	...
	local level = display.newText( newRecordMenu, value, 0, 0, FONT, 21 )
	...
	viewManager.buildButton(newRecordMenu, "", 	COLORS[4], 22, newRecordMenu.board.x + newRecordMenu.board.contentWidth/2 - 50, 	display.contentHeight*0.58, router.openScore)
