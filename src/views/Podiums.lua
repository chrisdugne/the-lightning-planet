...
function scene:buildContent()
	...
	self:buildTable(T "Classic", 				1, GLOBALS.savedData.scores.classic)
	self:buildTable("Time Attack Easy", 	2, GLOBALS.savedData.scores.timeattackeasy)
	self:buildTable("Time Attack Hard", 	3, GLOBALS.savedData.scores.timeattackhard)
	self:buildTable("Time Attack Extreme", 4, GLOBALS.savedData.scores.timeattackextreme)
	self:buildTable("Kamikaze Easy",	 		5, GLOBALS.savedData.scores.kamikazeeasy)
	self:buildTable("Kamikaze Hard", 		6, GLOBALS.savedData.scores.kamikazehard)
	self:buildTable("Kamikaze Extreme", 	7, GLOBALS.savedData.scores.kamikazeextreme)
